...
class ParallelProcessCaller(object):
    def __init__(self, cmd, args):
        ...
        self.proc = multiprocessing.Process(
            target=ParallelProcessCaller.process_target,
            args=(self.__queue, cmd) + tuple(args))
        self.proc.start()
            ...
            while True:
                try:
                    ...
                    if self.proc.is_alive:
                        ...
                        raise ParallelProcessCallerError(
    ...
    if n_worker > 1:
        ...
        try:
            ...
            for i, r in enumerate(async_results):
                r.get(
                    10 * 60)  # Results must be ready within 10 minutes each...
        except Exception as e:
